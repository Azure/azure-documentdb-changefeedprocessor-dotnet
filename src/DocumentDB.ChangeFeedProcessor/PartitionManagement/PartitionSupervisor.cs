...
namespace Microsoft.Azure.Documents.ChangeFeedProcessor.PartitionManagement
{
    ...
    internal class PartitionSupervisor : IPartitionSupervisor
    {
        ...
        public PartitionSupervisor(ILease lease, Processing.IChangeFeedObserver observer, IPartitionProcessor processor, ILeaseRenewer renewer)
        {
            this.lease = lease;
        ...
        {
            var context = new Processing.ChangeFeedObserverContext(this.lease.PartitionId);
