...
namespace Microsoft.Azure.Documents.ChangeFeedProcessor
{
    ...
    public class ChangeFeedEventHost
    {
        ...
        /// <param name="hostOptions">Additional options to control load-balancing of <see cref="Microsoft.Azure.Documents.ChangeFeedProcessor.ChangeFeedEventHost" /> instances.</param>
                                   ...
                                   ChangeFeedHostOptions hostOptions)
        {
            ...
            if (documentCollectionLocation == null)
                throw new ArgumentNullException(nameof(documentCollectionLocation));
            if (auxCollectionLocation == null)
                throw new ArgumentNullException(nameof(auxCollectionLocation));
        ...
        /// <returns>A task indicating that the <see cref="Microsoft.Azure.Documents.ChangeFeedProcessor.ChangeFeedEventHost" /> instance has started.</returns>
